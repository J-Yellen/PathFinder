...
class Results():
    ...
    """
    def __init__(self, paths:list, weights:list, top:int=1, ignore_subset:bool=False):
    ...
    def add_res(self, path:list, weight:float, trim_to_top:bool=True, bisect=True)-> None:
    ...
    def remap_path(self, index_map:list)->list:
        ret = []
